...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.35741100 1329207953';
var cnzz_a=gc_cnzz("cnzz_a2397884");
...
var cnzz_sin = gc_cnzz("sin2397884");
if(cnzz_sin==-1) cnzz_sin='none';
if( cnzz_ref.split('/')[2]!=document.domain ) cnzz_sin=cnzz_ref;
var cnzz_eid=gc_cnzz("cnzz_eid");
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1329207953+"-"+cnzz_ref.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=2397884" target=_blank title="&#31449;&#38271;&#32479;&#35745;">&#31449;&#38271;&#32479;&#35745;</a>');
document.write('<img src="http://hzs15.cnzz.com/stat.htm?id=2397884'+cnzz_data+'" border=0 width=0 height=0 />');
...
document.cookie="cnzz_a2397884="+cnzz_a+";expires="+cnzz_ed.toGMTString()+ "; path=/";
document.cookie="sin2397884="+escape(cnzz_sin)+ ";expires="+cnzz_ed.toGMTString()+";path=/";
